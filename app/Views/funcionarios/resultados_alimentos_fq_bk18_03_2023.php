                    ...
                    <?php foreach($certificado->fechasUtiles as $key_fecha => $fechaVidaUtil): ?>
                        ...
                        <table class="striped centered table_resultados" id="table_<?= $fechaVidaUtil->id ?>" <?= $key_fecha == 0 ? '' : 'style="display:none"' ?>>
                            ...
                            <tbody>
                                <tr>
                                    <td> <?php
                                            //$result = procesar_registro_fetch('ensayo_vs_muestra', 'id_ensayo_vs_muestra', $certificado->id_ensayo_vs_muestra);
                                           // echo 'certificado->id_muestra:'.$certificado->otros[0][0]->id_muestra;  ?></td>
                                </tr>
...
*/
                    ...
                    $predicado      = "WHERE em.id_muestra=".$certificado->otros[0][0]->id_muestra." AND pa.id_calculo <>1 AND cfq.tipo_formula ='Normal' ORDER BY trim(cfq.descripcion) ";//36
                    ...
                    $predicado      = "WHERE em.id_muestra=".$certificado->otros[0][0]->id_muestra." AND pa.id_calculo <>1 AND cfq.tipo_formula ='Compuesta' ORDER BY trim(cfq.descripcion) ";//36
