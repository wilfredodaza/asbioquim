            ...
            <?php foreach($certificado->fechasUtiles as $key_fecha => $fechaVidaUtil): ?>
                ...
                <table class="striped centered table_resultados" id="table_<?= $fechaVidaUtil->id ?>" <?= $key_fecha == 0 ? '' : 'style="display:none"' ?>>
                    ...
                    <tbody>
                            ...
                            <!-- ojo falta implementar  23/03/2023-->
                    ...
                    $predicado      = "WHERE em.id_muestra=".$certificado->id_muestra_detalle." 
                                            ...
                                            ".$id_salida."
                                            ORDER BY trim(cfq.descripcion) ";//36
                    ...
                    foreach ($salida_formulados as $key1 => $parametro1):
                        ...
                        echo '<br>id_muestra_detalle --->'.$parametro1->id_muestra_detalle;
                    ...
                    <tr>
                        <td>
                            <p class="center-align" style="background-color:#00429d;  color: #FFFFFF;">
                            ...
                            <div class="row">            
                                <div class="col col s12 l6">
                                    <p class="center-align" style="background-color:#4771b2;  color: #FFFFFF;">Resultado:</p>
                                    <b id="campo_respuesta_agua_f_<?= $parametro1->id_ensayo_vs_muestra ?>"><?= $result[0]->result_8 ?></b>
                                    
                                </div>
                                <div class="col col s12 l6">
                                    <p class="center-align" style="background-color:#4771b2;  color: #FFFFFF;">IRCA:</p>
                                    <b id="campo_respuesta_irca_f_<?= $parametro1->id_ensayo_vs_muestra ?>"><?= $result[0]->result_irca ?></b>
                                        ...
                                        <tr>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col col s12 l4">
                                                    <p class="center-align" style="background-color:#4771b2;  color: #FFFFFF;">Resultado final</p>
                                                    <b id="campo_respuesta_agua_<?= $aux ?>"><?= $result[0]->result_8 ?> </b>
                                                </div>
                                                
                                                <div class="col col s12 l4">
                                                    <p class="center-align" style="background-color:#4771b2;  color: #FFFFFF;"><?=$aux_irca_titulo ?> </p>
