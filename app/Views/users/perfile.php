                                ...
                                <div class="col s12" id="account">
                                    <?php if(session('user')->funcionario): ?>
                                        ...
                                        <div class="media display-flex align-items-center mb-2">
                                            <a class="mr-2" href="#">
                                                <img src="<?= !empty(session('user')->usr_foto) ? base_url() . '/upload/images/' . session('user')->usr_foto : base_url() . '/assets/img/user.png' ?>"
                                        ...
                                        <form action="<?= base_url() ?>/GestionLabs/update_photo" method="post" enctype="multipart/form-data">
                                    ...
                                    <form id="accountForm" action="<?= base_url() ?>/GestionLabs/update_user" method="post">
                                        <div class="row">
                                            <div class="col s12 m6">
                                                <div class="row">
                                                    <div class="col s12 input-field">
                                                        <input id="name" name="name" type="text" disabled
                                                               value="<?= $data->funcionario ? $data->nombre : $data->name ?>">
                                                    ...
                                                    <div class="col s12 input-field">
                                                        <input id="email" name="email" type="email" disabled
                                                               value="<?=  $data->funcionario ? $data->usr_correo : $data->email ?>">
                                                ...
                                                <div class="row">
                                                    <div class="col s12 input-field">
                                                        <input id="username" name="username" type="text" disabled
                                                               value="<?=  $data->funcionario ? $data->usr_usuario : $data->username ?>">
                                                        <label for="username">Nombre de usuario</label>
                                                        <small class=" red-text text-darken-4"><?= $validation->getError('username') ?></small>
                                                    </div>
                                                    <div class="col s12 input-field  disabled">
                                                        <input id="role_id" name="rol" value="<?=  $data->funcionario ? $data->cms_rol : $data->usertype ?>" type="text" disabled>
                                                        <label for="role_id">Rol</label>
                                                    </div>
                                                </div>
                                            </div>
                                            
                                            <?php if($data->funcionario): ?>

                                                <div class="col s12 m12">
                                                    <div class="row">
                                                        <div class="col s12 input-field">
                                                            <input id="password" name="password" type="password"
                                                                value="<?= $data->funcionario ? $data->usr_clave : $data->password ?>">
