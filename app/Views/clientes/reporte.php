                                ...
                                <div class="col s12 m12 l12">
                                    <div id="weekly-earning" class="card animate fadeUp">
                                        <div class="card-content">
                                            ...
                                            <form autocomplete="off" id="form_reporte" action="<?= base_url(['cliente/reporte'])?>"method="POST">
                                                <div class="input-field col s12 l6 m12 x1">
                                                    <select name="conformidad" id="conformidad">
                                                          <option value="" selected >Sin filtrar</option>
                                                          <option value="Cumple">Cumple</option>
                                                          <option value="No cumple">No cumple</option>
                                                          <option value="No aplica">No aplica</option>
                                                    </select>
                                                                            <!--<input name="concepto" id="concepto" autocomplete="off" type="text">-->
                                                ...
                                                <div class="input-field col s12 l3 m12 x13">
                                                    <input name="producto" id="producto" autocomplete="off" type="text">
                                                    <label for="producto">Productos</label>
                                                </div>
                                                <div class="input-field col s12 l3 m12 x13">
                                                    <input name="seccional" id="seccional" autocomplete="off" type="text">
...
<!-- <script src="<?= base_url(['app-assets', 'vendors', 'chartjs', 'chart.min.js']) ?>"></script> -->
    <!-- <script src="../../../app-assets/js/scripts/charts-chartjs.js"></script> -->
<script>
    ...
    $('#filtrar').click(function (e) {
        ...
        var proceso = proceso_fetch(url, data);
        proceso.then(respuesta => {
            console.log(respuesta);
            var total = [];
            var mes = [];
            respuesta.data.forEach(algo => {
                total.push(algo.total)
                mes.push(algo.mes);
            });
            $('#miCanvas').remove();
            $('.yearly-revenue-chart').append('<canvas id="miCanvas" class="firstShadow" height="350"></canvas>');
