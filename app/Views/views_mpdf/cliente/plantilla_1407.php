			...
			<table class="table" width="100%">
    						...
    						<td><?= $incertidumbre ?></td>
								...
								<td>
								    ...
								    if($array_1407["Pendientes"] > 0 || $array_1407["No aplica"] > 0 ){
								        ...
								        if ($array_1407["c"] >= $array_1407["No Cumple"]){
								            $cumple = "Cumple";
								        }else{
								            $cumple = "No cumple";
								        } 
								    }
								    $cumple .='<br>C('.$array_1407["c"].') Cumple('.$array_1407["Cumple"].') No cumple('.$array_1407["No Cumple"].') Pendiente('.$array_1407["Pendientes"].') No aplica('.$array_1407["No aplica"].')';
				...
				<?php if($frm_plantilla == 1): ?>
    				<div class="texto-especificacion">
    					...
    					<?php endif ?>
    					<br>En Asbioquim SAS contamos con acreditación ONAC vigente a la fecha con código de acreditación 19-LAB-002, bajo la norma NTC-ISO/IEC 17025:2017.
