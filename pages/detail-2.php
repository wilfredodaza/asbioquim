    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6 pl-lg-5 py-4 py-xl-5 order-lg-2">
                <h3 class="mb-4">Análisis Fisicoquímicos</h3>
                <p class="mb-4">Método cuyo objetivo es estudiar las relaciones entre propiedades físicas y composición del sistema para establecer interacciones entre los componentes químicos.</p>
                <ul class="list-unstyled pb-4 pb-lg-5 mb-0">
                </ul>
            </div>
            <div class="col-lg-6 order-lg-1">
                <img class="img-fluid" src="<?= $base_url ?>/public/page/images/my_image/analisis/fisicoquimico.jpg" alt="">
            </div>
        </div>
    </div>
</section>
