    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6 pl-lg-5 py-4 py-xl-5 order-lg-2">
                <h3 class="mb-4">Análisis de Aguas</h3>
                <p class="mb-4">Proceso químico en el que se extrae una buena muestra del líquido a analizar (dependiendo de la extensión del estudio, se puede llegar a necesitar hasta 1,5 litros). A partir de esa muestra, se determinará su calidad.</p>
                <ul class="list-unstyled pb-4 pb-lg-5 mb-0">
                </ul>
            </div>
            <div class="col-lg-6 order-lg-1">
                <img class="img-fluid" src="<?= $base_url ?>/public/page/images/my_image/analisis/agua.jpg" alt="">
            </div>
        </div>
    </div>
</section>
