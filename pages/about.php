...
<!--=================================
  banner -->
  <section class="inner-banner bg-holder bg-light space-ptb bg-overlay-black-50" style="background-image: url('<?= $base_url ?>/public/page/images/my_image/fondos/02.jpg');">
    <div class="container">
        <div class="row justify-content-start">
            <div class="col-md-6">
                <h1 class="text-white mb-3">Quienes somos</h1>
                <p class="inner-subtitle text-white">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Recusandae, sed? Quasi nam quas accusamus dolorum et, qui laborum tempore libero dolorem atque consequuntur harum sit, illum voluptas doloremque maxime. Sapiente!</p>
        ...
        <div class="row">
            <div class="col-12">
                ...
                <ul class="nav nav-tabs nav-tabs-02 justify-content-center" id="myTab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" id="department01-tab" data-toggle="tab" href="#department01" role="tab" aria-controls="department01" aria-selected="false">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" id="departments02-tab" data-toggle="tab" href="#departments02" role="tab" aria-controls="departments02" aria-selected="true">
                            <div class="feature-icon">
                ...
                <div class="tab-content pt-5" id="myTabContent">
                    <!-- department01 START -->
                    <div class="tab-pane fade show active" id="department01" role="tabpanel" aria-labelledby="department01-tab">
                        <div class="row align-items-center">
                            <div class="col-lg-12 pl-3 pl-lg-4">
                                <h3 class="mb-4">Mision</h3>
                                <p class="mb-1 mb-lg-1">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Libero distinctio officia dignissimos! Perferendis inventore facilis hic, molestias, doloribus laboriosam repudiandae molestiae dolorem velit, assumenda tempore!
                                    Neque necessitatibus velit placeat ullam.</p>
                            </div>
                        </div>
                    </div>
                    <!-- department01 END -->
                    ...
                    <div class="tab-pane fade" id="departments02" role="tabpanel" aria-labelledby="departments02-tab">
                        <div class="row align-items-center">
                            <div class="col-lg-12 pl-3 pl-lg-4">
                                <h3 class="mb-4">Vision</h3>
                                <p class="mb-4 mb-lg-5">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ut, error! Modi dolore similique assumenda odit consequuntur ad obcaecati fuga. Quos quo architecto excepturi deserunt natus doloribus debitis molestias magni facilis!</p>
                            </div>
                        </div>
                    </div>
