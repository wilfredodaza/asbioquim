...
<!--=================================
    Departments -->
    <section class="mb-2 overflow-hidden animate pulse">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6 pl-lg-5 py-4 py-xl-5 order-lg-2">
                <h3 class="mb-4">Análisis Microbiológicos</h3>
                <p class="mb-4">Uso de métodos biológicos, bioquímicos, moleculares o químicos para la detección, identificación o enumeración de microorganismos en un material.</p>
                <ul class="list-unstyled pb-4 pb-lg-5 mb-0">
                    <li class="mb-3 d-flex"><i class="far fa-plus-square pr-2 text-primary mt-1"></i>Muestreo</li>
                    <li class="mb-3 d-flex"><i class="far fa-plus-square pr-2 text-primary mt-1"></i>Filtración</li>
                    <li class="mb-3 d-flex"><i class="far fa-plus-square pr-2 text-primary mt-1"></i>Cultivo</li>
                    <li class="mb-3 d-flex"><i class="far fa-plus-square pr-2 text-primary mt-1"></i>Incubación</li>
                </ul>
            </div>
            <div class="col-lg-6 order-lg-1">
                <img class="img-fluid" src="<?= $base_url ?>/public/page/images/my_image/analisis/microbiologico.jpg" alt="">
            </div>
        </div>
    </div>
</section>
